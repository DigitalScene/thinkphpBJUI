<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageHeader">
    <form action="#" id="pageForm"  method="post" class="pageForm" data-toggle="ajaxsearch">
        ...
        <div class="bjui-searchBar">
            <label>项目名：</label><input type="text" name="search[title]" value="<?php echo ($search["title"]); ?>"/>
            ...
            <div class="pull-right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu right" role="menu">
                        <li><a href="#" data-toggle="dialog" data-width="1000" data-height="600" data-id="dialog-mask" data-mask="true"><i class="fa fa-plus "></i>新增项目 </a> </li>
                    </ul>
                </div>
            </div>
        </div>
