<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageHeader">
    ...
    <form id="pagerForm" data-toggle="ajaxsearch"  action="<?php echo U($Think.ACTION_NAME);?>" method="post">
        ...
        <div class="bjui-searchBar">
            <label style="font-size: large;margin: 5px 5px;"><?php echo ($dataUpload[projectName]); ?></label>
            ...
            <div class="pull-right">
                <div class="btn-group">
                 <button type="button" class="btn-default dropdown-toggle" data-toggle="dropdown" data-icon="copy">功能操作<span class="caret"></span> </button>
                    ...
                    <li><a href="<?php echo U('add?dataUploadID='.$dataUpload[id]);?>" data-toggle="dialog" data-width="880" data-height="250" data-id="dialog-mask" data-mask="true"><i class="fa fa-plus "></i>新增场景 </a> </li>
                    </ul>
                </div>
            </div>
        </div>
